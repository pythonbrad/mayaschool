...
urlpatterns = [
    ...
    path('classes/child', views.subclass.index, name='subclasses'),
    path('classes/child/create', views.subclass.create, name='new_subclass'),
    path('classes/child/<int:pk>/edit', views.subclass.edit, name='edit_subclass'),
    path('classes/child/<int:pk>/delete', views.subclass.delete, name='delete_subclass'),
